...
import lk.edu.ijse.sas.service.custom.IdService;
...
public class IdServiceImpl implements IdService{
    ...
    public IdServiceImpl() {
        ...
        idBO=(IdBO) BOFactory.getInstance().getBO(BOFactory.BOTypes.IDGEN);
    }
    ...
    public String getNewId(String tblName, String colName, String preFix, int digitCount) throws Exception {
        ...
        String lastId = idBO.getNewId(tblName, colName);
        if (null != lastId) {
