 ...
 * @author Vidura
 */
public class Remove_receive_materialDTO extends SuperDTO{
    ...
    public Remove_receive_materialDTO() {
    }

    public Remove_receive_materialDTO(String mid, String brid, BigDecimal qty_kg, String remove_date, String remove_time, String carry_sector_name) {
        this.mid = mid;
        this.brid = brid;
        this.qty_kg = qty_kg;
